...
background-repeat: no-repeat;
                ...
                <div class="collapse navbar-collapse" id="collapsibleNavId">
                    ...
                    <form class="d-flex my-2 my-lg-0" action="logout.php">
                        ...
                        <button
                            ...
                            type="submit"
                            style="background-color: rgba(137, 43, 226, 0.415)">Logout
                        </button>
    ...
    <main>
        <div class="container col-md-7 mb-5 mt-5">
            ...
            <div
                ...
                <table
                    ...
                    <thead>
                        <tr>
                            <th style="background-color: rgba(205, 180, 219, 0.34);">Id</th>
                            <th style="background-color: rgba(205, 180, 219, 0.34);">Name</th>
                            <th style="background-color: rgba(205, 180, 219, 0.34);">Age</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php
                        include 'db.php';
                        $stmt = "SELECT * from empinfo";
    ...
    <footer
        class=" text-center p-2 fixed-bottom"
